...
<body>
    ...
    <header>
        ...
        <a href="#postRecipe">Post a Recipe</a>
            <a href="#home">Home</a>
...
<!-- Post Button Section -->
<!-- Add this inside the <section class="home" id="home"> -->

<!-- Post Button Section -->
<section id="postRecipe" class="post-recipe">
    ...
    <form action="post_recipe.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="inputBox">
            ...
            <input type="text" name="recipeName" placeholder="Enter the recipe name" required>
        </div>

        <div class="inputBox">
            <label for="recipeDescription">Recipe Description</label>
            <textarea name="recipeDescription" cols="30" rows="10" placeholder="Write the recipe details here..." required></textarea>
        </div>

        <input type="submit" value="Post Recipe" class="btn">
    </form>
</section>
    ...
    <div class="box-container">
        <?php
        include 'db_conn.php';
        $query = "SELECT * FROM recipes ORDER BY id DESC LIMIT 6"; // Fetch the latest 6 recipes
        $result = mysqli_query($conn, $query);

        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="box" data-aos="fade-left">';
            echo '<img src="'. $row['image'] .'" alt="">';
            echo '<h3>' . $row['title'] . '</h3>';
            echo '<div class="icons">';
            echo '<a href="#" class="fas fa-eye" onclick="showRecipeDetails(' . $row['id'] . ')"></a>';
            echo '</div>';
            echo '</div>';
        }
        ?>
...
<div id="recipe-details-modal" style="display:none;">
...
function showRecipeDetails(recipeId) {
    // Fetch recipe details using Ajax and display in modal
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content" data-aos="fade-up">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo fugit odio doloribus ab, nostrum aperiam consequatur error iusto, beatae necessitatibus eum, reiciendis eaque similique aspernatur id.
                 Accusamus, error. Exercitationem, nesciunt? </p>
                <div class="up"></div>
    ...
    <section class="contact" id="contact">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p> <i class="fas fa-phone"></i>6565565</p>
                <p> <i class="fas fa-envelope"></i>ry</p>
